        ...
        className='flex bg-white rounded-xl max-w-4xl max-md:mx-2 relative'>
            ...
            <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
                ...
                <div className='w-full mt-4'>
                    ...
                    placeholder='Enter Hotel Name' className='border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light' required />
                </div>
                ...
                <div className='w-full mt-4'>
                    ...
                    onChange={(e)=> setContact(e.target.value)} value={contact}
                     placeholder='Enter Phone Number' className='border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light' required />
                </div>
                ...
                <div className='w-full mt-4'>
                    ...
                    onChange={(e)=> setAddress(e.target.value)} value={address}
                     placeholder='Enter Address' className='border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light' required />
                </div>
