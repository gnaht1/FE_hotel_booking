...
const Hero = () => {
    ...
    return (
        ...
        1g:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.jpg")] bg-cover bg-center bg-no-repeat h-screen'>
            <h1 className='font-playfair text-2xl md:text-5x1 md:text-[56px] md:leading-[56px] font-bold md:leading-[64px] font-extrabold max-w-xl mt-4'> Book Your Stay<br />Start Your Story</h1>
